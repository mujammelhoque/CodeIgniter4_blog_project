...
class Ch9 extends BaseController
{
	protected $ar;
	public $s;
	public $l;
	...
	public function index()
	{
        ...
        $str =  $view->setVar('allarticles', $data['allarticles'])
     ->setVar('inactivearticle', $data['inactivearticle'])
     ->render("ch9/index");
    //  echo $pdf;
    //  exit;
    
//     $fonturl = base_url() . "/assets/fonts/kalpurush.ttf";
//     $style = "<style>@font-face {
//         font-family: 'kalpurus';
//         font-style: normal;
//   font-weight: normal;
//         src: url('".$fonturl."') format('truetype');
//         } *{font-family:kalpurus,sans-serif;} h3{color:green;}</style>";
//     $str = "<html><head><meta charset='UTF-8'><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"/>".$style."</head><body><h3>Title: টিকা নিতে আগ্রহ বাড়ছে</h3><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sint, unde esse commodi voluptas vero ex illum quas minus veniam sapiente, eveniet necessitatibus voluptatibus nesciunt tempora error ea facere alias fugit?</p></body></html>";
    // echo $str; exit;
